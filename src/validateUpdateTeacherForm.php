...
//  include("C:\Users\davassayah\Desktop\P_Appro2\src\uploadImages\RenameImages.php");
//  include("C:\Users\davassayah\Desktop\P_Appro2\src\uploadImages\UpdateImages.php");
...
function validationTeacherForm($db,$teacher)
{
...
if (count($errors) === 1 && isset($errors['downloadImg'])) {
    // Supprimer l'erreur "downloadImg"
    $errors = [];
}
